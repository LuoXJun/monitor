...
// import headBg from '@/assets/imgs/myUpdate/Head.png'
...
//         <div
//           class={[
//             'absolute bottom-0 left-0 h-[calc(100%-var(--top-tool-height)-var(--tags-view-height))] layout-border__right',
...
//           <Menu></Menu>
//         </div>
//         <div style='background:url(/src/assets/imgs/myUpdate/Head.svg) no-repeat;background-size:cover;width:100vw;' >
//               <ToolHeader
//                 class={[
...
//           class={[
//             `${prefixCls}-content`,
//             'absolute bottom-0 h-[calc(100%-var(--top-tool-height)-var(--tags-view-height))]',
//             {
...
import { ElScrollbar } from 'element-plus'
import { useDesign } from '@/hooks/web/useDesign'
import headBg from '@/assets/imgs/myUpdate/Head.svg'
import MenuNew from './Menu/src/MenuNew.vue'
      ...
      <>
        <div style='width:100vw;' >
              ...
              <ToolHeader
               ...
               style={`background:url(${headBg}) no-repeat;background-size:cover;width:100vw`} >
             
              </ToolHeader>
               
              <MenuNew class="w-100vw  flex-1 px-0px" ></MenuNew>
              <Menu></Menu>
        ...
        <div
          class={[
            `${prefixCls}-content`,
            'absolute bottom-0 h-[calc(100%-var(--top-tool-height)-60px)]',
            {
              'w-[calc(100%-var(--left-menu-min-width))] left-[var(--left-menu-min-width)]':
                collapse.value && !mobile.value && !mobile.value,
          ...
          style={`transition: all var(--transition-time-02);${appStore.singleRoute?'width:100%!important;left:0':undefined}`}
        >
          <ElScrollbar
            v-loading={pageLoading.value}
            class={[
