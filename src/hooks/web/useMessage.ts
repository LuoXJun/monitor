 ...
 * @LastEditTime: 2024-12-23 10:59:13
 * @FilePath: \BD-ui\src\hooks\web\useMessage.ts
    ...
    exportConfirm(content?: string, tip?: string) {
      return ElMessageBox.confirm(
        ...
        tip ? tip : t('common.confirmTitle'),
        {
          ...
          cancelButtonText: t('common.cancel'),
          type: 'warning',
          icon: h(InfoFilled, { style: { color: '#e6a23c' } }), // 设置图标颜色
        }
      )
    },
    // 提交内容
    prompt(content: string, tip: string, inputPattern?: RegExp, inputErrorMessage?: string) {
