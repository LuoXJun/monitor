<template>
  ...
  >
    <el-row style="margin-right: -10px; margin-left: -10px">
      ...
      <el-col
        :span="24"
        style="padding-right: 10px; padding-left: 10px; margin-top: -20px; margin-bottom: -5px"
      >
        <el-form-item>
          <el-row justify="space-between" style="width: 100%">
            ...
            <el-col :offset="6" :span="12">
              <el-link style="float: right;margin-right: 10px;" type="primary">{{ t('login.forgetPassword') }}</el-link>
            </el-col>
          </el-row>
        </el-form-item>
      </el-col>
