  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle">
    ...
    >
      ...
      <el-form-item label="模板编号" prop="code">
        <el-input v-model="formData.code" maxlength="40" placeholder="请输入模板编号" />
      </el-form-item>
      <el-form-item label="模板名称" prop="name">
        <el-input v-model="formData.name" maxlength="180" placeholder="请输入模板名称" />
      </el-form-item>
      <el-form-item label="模板内容" prop="content">
        <el-input v-model="formData.content" maxlength="500" placeholder="请输入模板内容" type="textarea" />
      </el-form-item>
      ...
      <el-form-item label="短信 API 模板编号" prop="apiTemplateId">
        <el-input v-model="formData.apiTemplateId" maxlength="180" placeholder="请输入短信 API 的模板编号" />
      </el-form-item>
