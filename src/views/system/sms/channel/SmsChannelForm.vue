  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle">
    ...
    >
      <el-form-item label="短信签名" prop="signature">
        <el-input v-model="formData.signature" maxlength="30" placeholder="请输入短信签名" />
      </el-form-item>
      ...
      <el-form-item label="备注" prop="remark">
        <el-input v-model="formData.remark" maxlength="500" placeholder="请输入备注" />
      </el-form-item>
      <el-form-item label="短信 API 的账号" prop="apiKey">
        <el-input v-model="formData.apiKey" maxlength="180" placeholder="请输入短信 API 的账号" />
      </el-form-item>
      <el-form-item label="短信 API 的密钥" prop="apiSecret">
        <el-input v-model="formData.apiSecret" maxlength="180" placeholder="请输入短信 API 的密钥" />
      </el-form-item>
      <el-form-item label="短信发送回调 URL" prop="callbackUrl">
        <el-input v-model="formData.callbackUrl" maxlength="180" placeholder="请输入短信发送回调 URL" />
      </el-form-item>
    </el-form>
    <template #footer>
