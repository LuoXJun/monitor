  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle" max-height="500px" scroll>
    ...
    >
      <el-form-item label="客户端编号" prop="secret">
        <el-input v-model="formData.clientId" maxlength="40" placeholder="请输入客户端编号" />
      </el-form-item>
      <el-form-item label="客户端密钥" prop="secret">
        <el-input v-model="formData.secret" maxlength="180" placeholder="请输入客户端密钥" />
      </el-form-item>
      <el-form-item label="应用名" prop="name">
        <el-input v-model="formData.name" maxlength="30" placeholder="请输入应用名" />
      </el-form-item>
      <el-form-item label="应用图标">
        <UploadImg v-model="formData.logo" :limit="1" />
      </el-form-item>
      <el-form-item label="应用描述">
        <el-input v-model="formData.description" maxlength="500" placeholder="请输入应用名" type="textarea" />
      </el-form-item>
