  ...
  <Dialog :title="dialogTitle" v-model="dialogVisible">
    ...
    >
      <el-form-item label="模版编码" prop="code">
        <el-input v-model="formData.code" maxlength="40" placeholder="请输入模版编码" />
      </el-form-item>
      <el-form-item label="模板名称" prop="name">
        <el-input v-model="formData.name" maxlength="180" placeholder="请输入模版名称" />
      </el-form-item>
      <el-form-item label="发件人名称" prop="nickname">
        <el-input v-model="formData.nickname" maxlength="30" placeholder="请输入发件人名称" />
      </el-form-item>
      <el-form-item label="模板内容" prop="content">
        <el-input type="textarea" v-model="formData.content" maxlength="500" placeholder="请输入模板内容" />
      </el-form-item>
      ...
      <el-form-item label="备注" maxlength="500" prop="remark">
