  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle" width="800">
    ...
    >
      <el-form-item label="岗位标题" prop="name">
        <el-input v-model="formData.name" maxlength="180" placeholder="请输入岗位标题" />
      </el-form-item>
      <el-form-item label="岗位编码" prop="code">
        <el-input v-model="formData.code" maxlength="40" placeholder="请输入岗位编码" />
      </el-form-item>
      <el-form-item label="岗位顺序" prop="sort">
        <el-input v-model="formData.sort" maxlength="99" placeholder="请输入岗位顺序" />
      </el-form-item>
