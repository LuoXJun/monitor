    ...
    >
      ...
      >
        <template #default="scope">
          <el-tag type="primary">
            {{ DictUseTypeMap[scope.row.useType]?.name }}
          </el-tag>
        </template>
      </el-table-column>
      ...
      <el-table-column align="center" label="操作" :width="200" fixed="right">
        <template #default="scope">
          ...
          <router-link :to="'/dict/type/data/' + scope.row.type">
            <el-button class="mx-10px" plain size="small" type="primary">数据</el-button>
          </router-link>
          <el-button
...
import { USE_TYPE_LIST, DictUseTypeMap } from './constants'
