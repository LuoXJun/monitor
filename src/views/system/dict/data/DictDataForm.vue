  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle">
    ...
    >
      ...
      <el-form-item label="数据标签" prop="label">
        <el-input v-model="formData.label" maxlength="180" placeholder="请输入数据标签" />
      </el-form-item>
      <el-form-item label="数据键值" prop="value">
        <el-input v-model="formData.value" maxlength="40" placeholder="请输入数据键值" />
      </el-form-item>
      ...
      <el-form-item label="CSS Class" prop="cssClass">
        <el-input v-model="formData.cssClass" maxlength="180" placeholder="请输入 CSS Class" />
      </el-form-item>
