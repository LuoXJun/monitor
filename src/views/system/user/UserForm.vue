<template>
  <Dialog v-model="dialogVisible" width="700px" :title="dialogTitle">
    <el-form
      ref="formRef"
      ...
      <el-row>
        <el-col :span="12" v-if="formData.id === undefined">
          <el-form-item  label="登录名" prop="username">
            <el-input v-model="formData.username" maxlength="180" placeholder="请输入登录名" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="用户昵称" prop="nickname">
            <el-input v-model="formData.nickname" maxlength="30" placeholder="请输入用户昵称" />
          </el-form-item>
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item label="备注">
            <el-input v-model="formData.remark" maxlength="500" placeholder="请输入内容" type="textarea" />
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
  ...
  password: [
    required,
    {
      validator: (rule: any, value: string, callback: any) => {
        validatePassword(value,formData.value.username, callback)
      },
      trigger: ['blur', 'change']
    }
  ],
...
const open = async (type: string, id?: number) => {
  ...
  if (id) {
    ...
    try {
      ...
      const list = await PermissionApi.getUserRoleList(id)
      formData.value.roleIds = list?.[0]
    } finally {
