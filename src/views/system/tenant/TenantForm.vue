  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle" width="50%">
    ...
    >
      <el-form-item label="租户名" prop="name">
        <el-input v-model="formData.name" maxlength="180" placeholder="请输入租户名" />
      </el-form-item>
      ...
      <el-form-item label="联系人" prop="contactName">
        <el-input v-model="formData.contactName" maxlength="30" placeholder="请输入联系人" />
      </el-form-item>
      <el-form-item label="联系手机" prop="contactMobile">
        <el-input v-model="formData.contactMobile" maxlength="11" placeholder="请输入联系手机" />
      </el-form-item>
      <el-form-item v-if="formData.id === undefined" label="登录名" prop="username">
      ...
      <el-form-item label="绑定域名" prop="website">
        <el-input v-model="formData.website" maxlength="180" placeholder="请输入绑定域名" />
      </el-form-item>
