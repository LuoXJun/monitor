<template>
  ...
  <ContentWrap>
    ...
    >
      ...
      <el-table-column label="分类编号" align="center" prop="id" sortable="custom" />
      <el-table-column label="分类名" align="center" prop="name" sortable="custom" />
      <el-table-column label="分类标志key" align="center" prop="code" sortable="custom" />
      <el-table-column label="分类描述" align="center" prop="description" sortable="custom" />
      <el-table-column label="分类状态" align="center" prop="status" sortable="custom">
        <template #default="scope">
          <dict-tag :type="DICT_TYPE.COMMON_STATUS" :value="scope.row.status" />
        </template>
      </el-table-column>
      <el-table-column label="分类排序" align="center" prop="sort" sortable="custom" />
      <el-table-column
        label="创建时间"
        align="center"
        prop="createTime"
