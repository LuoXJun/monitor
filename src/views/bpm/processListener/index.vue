<template>
  ...
  <ContentWrap>
    ...
    >
      ...
      <el-table-column label="事件" align="center" prop="event" sortable="custom" />
      <el-table-column label="值类型" align="center" prop="valueType" sortable="custom">
        <template #default="scope">
          <dict-tag
      ...
      <el-table-column label="值" align="center" prop="value" sortable="custom" />
      <el-table-column
        label="创建时间"
        align="center"
        prop="createTime"
