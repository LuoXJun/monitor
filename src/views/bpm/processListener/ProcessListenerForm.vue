  ...
  <Dialog :title="dialogTitle" v-model="dialogVisible">
    ...
    >
      <el-form-item label="名字" prop="name">
        <el-input v-model="formData.name" maxlength="180" placeholder="请输入名字" />
      </el-form-item>
      ...
      <el-form-item label="类路径" prop="value" v-if="formData.type == 'class'">
        <el-input v-model="formData.value" maxlength="180" placeholder="请输入类路径" />
      </el-form-item>
      <el-form-item label="表达式" prop="value" v-else>
        <el-input v-model="formData.value" maxlength="180" placeholder="请输入表达式" />
      </el-form-item>
    </el-form>
    <template #footer>
