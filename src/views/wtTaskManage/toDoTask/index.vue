  ...
  <div style="margin-top: 15px">
    <ContentWrap>
      ...
      >
        ...
        <el-form-item label="物探指标" prop="siloStatus">
          <el-select
    ...
    <ContentWrap class="full-height">
      <el-table v-loading="loading" @selection-change="handleSelectionChange" :data="list" border>
        ...
        <el-table-column
          ...
          show-overflow-tooltip
        />
        <el-table-column label="任务编号" align="center" prop="taskId" show-overflow-tooltip />
        ...
        <el-table-column align="center" label="任务创建时间" prop="taskCreateTime" width="180">
          <template #default="scope">
