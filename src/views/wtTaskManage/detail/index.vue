  ...
  >
    <div class="dialog-content">
      ...
      <el-tabs v-model="activeName" @tab-click="handleTabClick">
        ...
        <el-tab-pane :label="PROCESS_TABS_MAP.wtDetail.name" :name="PROCESS_TABS_MAP.wtDetail.key">
          <div class="card-wrap">
            <el-card v-loading="processInstanceLoading" class="box-card">
              <WtDetail
                :sampleId="sampleId"
...
const activeName = ref(PROCESS_TABS_MAP.wtDetail.key)
const formData = ref({
  nextMen: ''
})
...
const setTabsActive = () => {
  if (runningTasks.value?.length) {
    ...
    activeName.value = PROCESS_TABS_MAP.wtDetail.key
