    ...
    <el-row>
      ...
      <el-col :span="12">
        <el-form-item prop="moduleName">
          ...
          <el-input v-model="formData.moduleName" maxlength="180" />
        </el-form-item>
      </el-col>
      ...
      <el-col :span="12">
        <el-form-item prop="businessName">
          ...
          <el-input v-model="formData.businessName" maxlength="180" />
        </el-form-item>
      </el-col>
      ...
      <el-col :span="12">
        <el-form-item prop="className">
          ...
          <el-input v-model="formData.className" maxlength="180" />
        </el-form-item>
      </el-col>
      ...
      <el-col :span="12">
        <el-form-item prop="classComment">
          ...
          <el-input v-model="formData.classComment" maxlength="180" />
        </el-form-item>
      </el-col>
      ...
      <el-col v-if="formData.genType === '1'" :span="24">
        <el-form-item prop="genPath">
          ...
          <el-input v-model="formData.genPath" maxlength="180">
            <template #append>
              <el-dropdown>
