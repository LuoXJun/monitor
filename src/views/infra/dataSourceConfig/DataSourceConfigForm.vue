  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle">
    ...
    >
      ...
      <el-form-item label="数据源连接" prop="url">
        <el-input v-model="formData.url" maxlength="180" placeholder="请输入数据源连接" />
      </el-form-item>
      <el-form-item label="用户名" prop="username">
        <el-input v-model="formData.username" maxlength="40" placeholder="请输入用户名" />
      </el-form-item>
      <el-form-item label="密码" prop="password">
        <el-input v-model="formData.password" maxlength="30" placeholder="请输入密码" />
      </el-form-item>
    </el-form>
    <template #footer>
