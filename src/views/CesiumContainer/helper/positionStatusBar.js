 ...
 * @LastEditors: cc
 * @LastEditTime: 2024-07-10 16:02:01
    ...
    if (position) {
      ...
      if(pitchDegree>60){
        ...
        this.viewer.scene.camera.setView({
          orientation: {
            heading: Cesium.Math.toRadians(headingDegree),
            pitch: Cesium.Math.toRadians(pitchDegree),
          }
        })
      }
      ...
      this.divCameraHeight.textContent = `相机高度:${height.toFixed(2)}米`;
    }
  }
